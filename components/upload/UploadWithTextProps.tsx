...
// ----------------------------------------------------------------------
type PlaceholderProps = StackProps & {titleText: string} & {descriptionText: string | React.ReactNode}
function Placeholder({ sx, titleText, descriptionText, ...other }: PlaceholderProps) {
    return (
        <Stack
            alignItems="center"
